...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_BSPC,        KC_N,           KC_R,           KC_T,           MT(MOD_LSFT, KC_S),KC_G,                                           KC_Y,           MT(MOD_RSFT, KC_H),KC_A,           KC_E,           KC_I,           KC_COMMA,       
    KC_LEFT_GUI,    KC_Q,           KC_X,           KC_M,           KC_C,           KC_V,                                           KC_K,           KC_P,           KC_DOT,         KC_MINUS,       KC_SLASH,       KC_RIGHT_CTRL,  
